...
namespace Actiance.Controllers
{
    public class AccountController : ApiController
    {
        ...
        string authority = string.Format("https://{0}/{1}/adminconsent?client_id={3}&state=auth&redirect_uri={4}", aadInstance, tenant, clientId, redirectUri);
